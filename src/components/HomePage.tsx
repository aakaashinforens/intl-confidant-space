...
import { Users, Globe, GraduationCap, MessageCircle, ArrowRight, Sparkles } from "lucide-react";
...
const HomePage = () => {
  ...
  const stats = [
    ...
    { icon: GraduationCap, label: "Students", value: "47K+", color: "text-secondary" },
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/3 w-80 h-80 bg-secondary/20 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
        ...
        <Card className="glass-card p-8 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Someone's always online across different time zones - never feel alone
              </p>
            </div>
            <div className="text-center">
